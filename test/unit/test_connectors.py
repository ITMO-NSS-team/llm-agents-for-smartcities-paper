...
@pytest.mark.parametrize('models', [{'url': os.environ['LLAMA_URL'], 'template': llama_70b_template, 'func': llama_70b_postprocessing},
                                    {'url': os.environ['LLAMA_FC'], 'template': llama_8b_template, 'func': llama_8b_postprocessing}])
