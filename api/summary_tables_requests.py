...
Possible table names:
    ...
    Отраслевой контекст - здравоохранение Отраслевой контекст - здравоохранение
...
def get_summary_table(
    table: str, name_id: str = None, type: str = None, coordinates: List = None
) -> Dict:
...
if __name__ == "__main__":
    ...
    coords = [
        {"t": "city", "coords": spb_coords, "type": "MultiPolygon"},
        {"t": "district", "coords": vuborg_district_coords, "type": "Polygon"},
        {
            "t": "municipality",
            "coords": krasnoe_selo_mo_coords,
            "type": "MultiPolygon",
        },
    ...
    for table in tables:
        for element in coords:
            try:
                ...
                pass
                print(
                    f'ERROR: {table} has issues with {(element.get("t"))} data'
                )
                print(e)
        print("-------------------------------------------------")
