...
tools = [
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {"city_service_type_id": {"type": "string"}},
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "city": {"type": "string"},
                "geometryAsCenter": {"type": "boolean"},
                "livingOnly": {"type": "boolean"},
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {"city": {"type": "string"}, "block_id": {"type": "string"}},
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "user_selection_zone": {"type": "string"},
                "valuation_type": {"type": "string"},
                "service_impotancy": {"type": "string"},
            },
            "required": [
                "city",
                "service_types",
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "table": {"type": "string"},
                "territory_name_id": {"type": "string"},
                "territory_type": {"type": "string"},
                "selection_zone": {"type": "string"},
            },
            "required": [
                "table",
                "territory_name_id",
...
def check_choice_correctness(question: str, answer: str, tools: List) -> str:
    sys_prompt = (
...
if __name__ == "__main__":
    ...
    extra_data = (
        'Coordinates: {"type": "polygon", "coords": [[[30.688828198781902, 59.775976109763285]]]}, '
        "territory type: city."
    )
