    ...
    def __call__(
        ...
        **kwargs,
        ...
        Args:
            ...
            top_p (float, optional): Nuclear sampling. Selects the most likely tokens from
            a probability distribution,
            considering the cumulative probability until it reaches a
            predefined threshold “top_p”. Defaults to 0.5.
...
class NewWebAssistant(WebAssistant):
    """Extends base."""
