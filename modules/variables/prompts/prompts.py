accessibility_sys_prompt = """Answer the question following rules below.
...
strategy_sys_prompt = """Answer the question following rules below. For answer you must
...
buildings_sys_prompt = """Your name is Larry. You are smart AI assistant, You have high
